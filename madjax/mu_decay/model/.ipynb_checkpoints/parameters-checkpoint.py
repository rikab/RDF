...
def calculate_full_parameters(slha):
        ...
        mdl_WTau = slha.get(("decay", 15), 2.270000e-12);
        ...
        mdl_MM = slha.get(("mass", 13), 1.056600e-01);
        mdl_Me = slha.get(("mass", 11), 5.110000e-04);
        ...
        mdl_ymm = slha.get(("yukawa", 13), 1.056600e-01);
        mdl_yme = slha.get(("yukawa", 11), 5.110000e-04);
        ...
        _result_params["mdl_WTau"] = (mdl_WTau.real)
        ...
        _result_params["mdl_MM"] = (mdl_MM.real)
        _result_params["mdl_Me"] = (mdl_Me.real)
        ...
        _result_params["mdl_ymm"] = (mdl_ymm.real)
        _result_params["mdl_yme"] = (mdl_yme.real)
        ...
        _result_params["mdl_ye"] = (mdl_ye.real)
        _result_params["mdl_ym"] = (mdl_ym.real)
